...
public final class QueryUtils {
     ...
     */
    public static ArrayList<Quaker> extractEarthquakes() {

        // Create an empty ArrayList that we can start adding earthquakes to
        ArrayList<Quaker> earthquakes = new ArrayList<>();
        ...
        try {
            ...
            for (int i = 0; i < earthQuakeArray.length(); i++) {
                // increment the loop to loop through every objects in the "features" arrsy
                JSONObject currentEarthquake = earthQuakeArray.getJSONObject(i);
                // get the object named "properties" and read the data in it
                JSONObject properties = currentEarthquake.getJSONObject("properties");

                // Extract the value for the key called "mag"
                double magnitude = properties.getDouble("mag");
                // Extract the value for the key called "location"
